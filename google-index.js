...
async function main() {
    ...
    jwtClient.authorize(async (err) => {
        ...
        // 4. Compile all URLs (strictly matching canonical & sitemap with trailing slash)
        const allUrls = [];
        ...
        districts.forEach((dist) => {
            // e.g. https://evolutionajans.com/hizmet-bolgeleri/balcova/
            allUrls.push(`${BASE_URL}/hizmet-bolgeleri/${dist.slug}/`);

            // e.g. https://evolutionajans.com/hizmet-bolgeleri/balcova/seo/
